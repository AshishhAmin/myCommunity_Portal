    ...
    return (
        <section className="relative overflow-hidden pt-12 pb-16 md:pt-32 md:pb-40">
            ...
            <div className="container relative mx-auto px-4 text-center">
                <div className="inline-flex items-center rounded-full border border-gold/40 bg-gold/10 px-4 py-1.5 text-xs md:text-sm font-bold text-maroon mb-6 md:mb-8 animate-slide-up shadow-sm">
                ...
                {mounted && !isLoading && !isAuthenticated && (
                    <div className="mt-8 md:mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 animate-slide-up [animation-delay:600ms]">
                        <Link href="/join" className="w-full sm:w-auto">
                            <Button size="lg" className="w-full sm:w-auto min-w-[200px] text-base md:text-xl h-12 md:h-14 shadow-lg hover:scale-105 transition-transform">
                                Join Community
                            </Button>
                        </Link>
                        <Link href="/login" className="w-full sm:w-auto">
                            <Button variant="outline" size="lg" className="w-full sm:w-auto min-w-[200px] text-base md:text-xl h-12 md:h-14 bg-white/50 backdrop-blur-sm shadow-md hover:scale-105 transition-transform">
                                Member Login
                            </Button>
                        </Link>
                    </div>
                ...
                {/* Trust Indicators */}
                <div className="mt-12 md:mt-20 grid grid-cols-2 gap-8 md:gap-10 md:grid-cols-4 border-t border-gold/10 pt-10 md:pt-12 max-w-5xl mx-auto animate-slide-up [animation-delay:800ms]">
